var QC = function() {
		...
		t = (e._reg = /\{(\w+)\}/g, {
			str2dom: function(t) {
				...
				return 1 < n.length ? function() {
					for (var t = document.createDocumentFragment(), e = 0; e < n.length; e++) t
						.appendChild(n[e]);
					return t
				}() : n[0]
			},
	...
	var d, i, p, u, l, h, f, m = function() {
			document.implementation.hasFeature("XPath", "3.0") && (XMLDocument.prototype.selectNodes = function(t,
				e) {
				e = e || this;
				for (var n = this.createNSResolver(this.documentElement), o = this.evaluate(t, e, n,
						XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null), i = [], r = 0; r < o
					.snapshotLength; r++) i[r] = o.snapshotItem(r);
				return i
			...
			return {
				...
				parse: function(t) {
					var e = a ? new ActiveXObject("Microsoft.XMLDOM") : document.implementation.createDocument(
						"text/xml", "", null);
		...
		g = {
			extend: function() {
				var t, e, n, o = arguments,
					...
					a = 1,
					s = o[0];
				for ("boolean" == typeof s && (r = s, s = arguments[1] || {}, a = 2), "object" != typeof s &&
					"function" != typeof s && (s = {}), i === a && (s = {}, --a); a < i; a++)
					if (null != (t = arguments[a]))
						for (var c in t) e = s[c], s !== (n = t[c]) && (r && n && "object" == typeof n && !n
							.nodeType ? (e = e || (n instanceof Array ? [] : "object" == typeof n ? {} : n),
								s[c] = object.extend(r, e, n)) : void 0 !== n && (s[c] = n));
				return s
			}
		},
		_ = (d = /"/g, i = {
			...
			commonDictionarySplit: function(t, e, n, o, i) {
				...
				if ("string" != typeof n && (n = ""), "string" != typeof o && (o = "="), (r = t.split(e =
						"string" != typeof e ? "&" : e)) && r.length)
					for (var d = 0, p = r.length; d < p; ++d) 1 < (a = r[d].split(o)).length ? (s = (s = a
						.slice(1).join(o).split(n)).slice(n.length, s.length - n.length).join(n), c[
						a[0]] = "function" == typeof i ? i(s) : s) : a[0] && (c[a[0]] = !0);
				return c
			},
			commonDictionaryJoin: function(t, e, n, o, i) {
				...
				for (a in "string" != typeof e && (e = "&"), "string" != typeof n && (n = ""), "string" !=
					typeof o && (o = "="), t) r = (t[a] + "").replace(d, '\\"'), s.push(a + o + n + (
					"function" == typeof i ? i(r) : r) + n);
				return s.join(e)
			}
		}, {
			stringify: function(t) {
		...
		v = (l = document.domain || "", {
			set: function(t, e, n, o, i) {
				var r;
				return i && (r = new Date).setTime(r.getTime() + 36e5 * i), document.cookie = t + "=" + e +
					"; " + (i ? "expires=" + r.toGMTString() + "; " : "") + (o ? "path=" + o + "; " :
						"path=/; ") + (n ? "domain=" + n + ";" : "domain=" + l + ";"), !0
			},
			get: function(t) {
			...
			del: function(t, e, n) {
				document.cookie = t + "=; expires=Mon, 26 Jul 1997 05:00:00 GMT; " + (n ? "path=" + n +
					"; " : "path=/; ") + (e ? "domain=" + e + ";" : "domain=" + l + ";")
			}
		}),
		w = (f = (h = {
			log: 3,
	...
	var q, q = (k.list = [], k.fired = !1, q || (q = !0, document.addEventListener ? document.addEventListener(
		"DOMContentLoaded",
		function() {
		...
		"complete" !== document.readyState && "loaded" !== document.readyState || (document
			.detachEvent("onreadystatechange", arguments.callee), k())
		...
		domReady: function(t) {
			"function" == typeof t && (k.fired || "complete" === document.readyState || "loaded" ===
				document.readyState ? (k(), t()) : k.list.push(t))
		},
		add: function(t, e, n) {
			t && e && n && (t && t.addEventListener ? t.addEventListener(e, n, !1) : t.attachEvent(
				"on" + e, n))
		},
		remove: function(t, e, n) {
			t && e && n && (t && t.removeEventListener ? t.removeEventListener(e, n, !1) : t
				.detachEvent("on" + e, n))
		}
	});
...
! function(g) {
	...
	~~g.QueryString.getParameter("__qc_wId") || ~~g.Cookie.get("__qc_wId") || (n = +new Date % 1e3, document.cookie = [
		"__qc_wId=" + n, "; path=/"
	].join(";"));
		...
		d = {
			...
			getCrossSolution: function() {
				var t = window.postMessage ? "PMProxy" : window.ActiveXObject && function() {
					...
					return e
				}() || navigator.plugins && navigator.plugins["Shockwave Flash"] ? "FLAProxy" : (g.Console
					.error("未找到可用的跨域通信方案"), "EMPProxy");
	...
	function u(t, e, n, o) {
		this.uri = t, this.paras = e || {}, this.fmt = n || "json", this.method = (o || "get").toLocaleLowerCase(), this
			.successPool = [], this.errorPool = [], this.completePool = [], this.seq = p++
	}
	u.prototype.success = function(t) {
		...
		var o;
		200 == t.status || 204 == t.status ? (o = t.responseText, ~~(o = new l(o, t.status, e, n)).code ? this
			.onError(o) : this.onSuccess(o)) : this.onError(new l("", t.status, e, n))
	...
	var l = function(t, e, n, o) {
		this.status = e || -1, this.fmt = n || "json", this.code = this.ret = -1, this.data = null, this.seq = o ||
			-1, this.parseData(t), this.code && l[this.code] && l[this.code](this.data, this.dataText)
	};
	l.prototype.parseData = function(t) {
		var e;
		this.dataText = t, "xml" === this.fmt ? (this.data = g.XML.parse(t || "<root></root>"), e = this.data
			.selectNodes("//ret")[0], this.code = this.ret = e && e.firstChild.nodeValue || -1) : (this.data = g
			.JSON.parse(t || "{}"), this.code = this.ret = void 0 !== this.data.ret ? ~~this.data.ret : this
			.data.data && void 0 !== this.data.data.ret ? ~~this.data.data.ret : -1)
	...
	g.Object.extend(h.prototype, {
		send: function() {
			var t = this.xhr,
				...
				r = "post" == e ? this.uri : this.uri.indexOf("?") < 0 ? this.uri + "?" + i : this.uri
				.replace(/[&?]*/g, "") + "&" + i;
			t.open(e, r, !!this.async);
			try {
				t.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), t.setRequestHeader(
					"X-Requested-From", "_TC_QC_jsProxy_")
			} catch (t) {}
	...
	function f() {
		this.requests = [], this.invokes = [], this.readyPool = [], this.isReady = !1, this.timeStamp = +new Date, this
			.init()
	}
	var m, b;
	f.prototype.init = k, f.prototype.ready = function(t) {
		...
		var e;
		for (t && this.requests.push(t); this.isReady && (e = this.requests.shift());) f.pendingRequests.push(e), QC
			.Console.log("seq no :" + e.seq + "请求发起  ts -> " + +new Date), this._doSend(e)
		...
		for (var i = f.pendingRequests, r = 0; r < i.length; r++)
			if (i[r].seq == t) return QC.Console.log("seq no :" + t + "响应收到  ts -> " + +new Date), i[r]
				._onCallback({
					status: n,
					responseText: e
		...
		g._create_fla_proxy = k, document._qc_cross_request_flash_proxy || _("_qc_cross_request_flash_proxy") ||
			new I
	};
	...
	g.Object.extend(I.prototype, {
		...
		init: function() {
			var t, e, o = this,
				n = (t = window.name.match(/oauth2Login_(\d+)/), e = ~~g.Cookie.get("__qc_wId"), t && t[1] ?
					n = t[1] : window._b_is_qc_cb_win ? n = 1e4 + e : (n = e, document.cookie = [
						"__qc_wId=" + n, "; path=/"
					].join(";")), g.Console.info("跨域窗口标识号 __qc_wId : " + n), n),
				n = I.getFlashHtml({
					src: d.FLACrossPage,
					width: "100%",
					height: "100%",
					...
					flashVars: "suffix=" + this.timeStamp + "&conId=" + n + "&conId_receive=" + (n <
						1e4 ? n + 1e4 : n - 1e4)
				}),
			...
			i.style.cssText =
				...
				i.innerHTML = n, QC.Event.domReady(function() {
		...
		_doSend: function(t) {
			var e = t.uri,
				...
				i = t.fmt,
				r = t.method,
				t = document._qc_cross_request_flash_proxy.httpRequest || _("_qc_cross_request_flash_proxy")
				.httpRequest;
		...
		_doInvoke: function(t) {
			var e = document._qc_cross_request_flash_proxy.jsCallSwf || _("_qc_cross_request_flash_proxy")
				.jsCallSwf;
			e && e.apply(null, t)
		}
		...
		for (o in e = e || 9, t) switch (o) {
			...
			case "style":
				...
				break;
			case "src":
				a ? r.push('<param name="movie" value="', t.noSrc ? "" : t[o], '"/>') : i.push(' data="', t
					.noSrc ? "" : t[o], '"');
				break;
			default:
				r.push('<param name="', o, '" value="', t[o], '" />')
		}
		return a ? i.push(' classid="clsid:', n || "D27CDB6E-AE6D-11cf-96B8-444553540000", '"') : i.push(
				' type="application/x-shockwave-flash"'), location && location.protocol.indexOf("https") < 0 && i
			.push(' codeBase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab#version=', e,
	...
	g.Object.extend(S.prototype, {
		init: function() {
			var e = this;
			e._connFrame = document.createElement("iframe"), e._connFrame.style.cssText =
				"width:0px; height:0px; display:none; overflow:hidden;";
			var t = function() {
				t.fire(), t.fire = k
			};
			t.fire = function() {
					g.Console.info("PMProxy代理创建成功，耗时" + (new Date - e.timeStamp)), e.isReady = !0, e.send(),
						e.invoke()
				}, e._connFrame.onload = t, e._connFrame.addEventListener && e._connFrame.addEventListener(
					"load", t, !1), e._connFrame.attachEvent && e._connFrame.attachEvent("onload", t), e
				._connFrame.src = d.PMCrossPage, QC.Event.domReady(function() {
					document.body.appendChild(e._connFrame)
				});

			function n(t) {
				!t.origin || t.origin != L && "https://qzonestyle.gtimg.cn" != t.origin || e._preDispatch(e,
					t)
			}
			window.addEventListener ? window.addEventListener("message", n, !1) : window.attachEvent(
				"onmessage", n)
		},
		_doSend: function(t) {
		...
		_doInvoke: function(t) {
			var e;
			g.Console.log("invoke:\t" + t), "string" == typeof t && (t = (e = t.split("#"))[0], e = e[1] &&
				e[1].split(","), f.getFunction(t).apply(null, e))
		},
		onDispose: function() {
	...
	function M(t) {
		...
		return t.paras.oauth_consumer_key = R, t.paras.access_token = e.accessToken, t.paras.openid = e.openid, t.paras
			.format = t.fmt, t
	}
	...
	function j(e, t, n, o) {
		...
		return 0 < R ? setTimeout(function() {
			...
			t.openid && t.accessToken ? b.send(M(r)) : (T.push(r), g.Console.log(
				"openid与accessToken丢失，调用请求入栈 : [" + e + "]，栈大小：" + T.length))
		}, 10) : (T.push(r), g.Console.log((b.isReady && R < 0 ? "token获取失败，请调用用户登录流程" : "api代理尚未初始化成功") +
			"，调用请求入栈 : [" + e + "]，栈大小：" + T.length)), r.success(function() {
	...
	g.api = (T = [], j._ready = function() {
		...
		var n, o, i;
		Q && e ? e(Q[t]) : (n = t, o = e || k, (i = document.createElement("script")).type =
			"text/javascript", i.src = "https://qzonestyle.gtimg.cn/qzone/openapi/qc_jsdkdoc.js",
			document.body.appendChild(i), window.on_qc_jsdkdoc_loaded = function(t) {
	...
	g.Login = function() {
		...
		function s(n) {
			...
			if (o < 0) QC.getAppId(arguments);
				...
				if (n && n.btnId) {
					...
					n.showModal ? ((c = document.createElement("DIV")).style =
						...
						c.innerHTML =
						'<iframe id="qq_login_iframe" frameborder="0" width="100%" height="100%"></iframe>', c
						.style.top = 0, c.style.left = window.innerWidth / 2 - 250 + "px", document.body
						.appendChild(c), t.firstChild.onclick = function() {
							var t, e = document.getElementById("qq_login_iframe");
							e.src || (t = "?", t += "response_type=token&", t += "client_id=" + o + "&", t +=
									"redirect_uri=" + n.redirectURI, e.src =
									"https://graph.qq.com/oauth2.0/authorize" + t), c.style.visibility =
								"visible"
						}) : t.firstChild.onclick = (a = r, window.addEventListener ? window.addEventListener(
						"unload", d, !1) : window.attachEvent("onunload", d), function() {
						return s && s.close(), s = a(), g._create_fla_proxy(), QC.pv("graph.qq.com",
							"/open/connect/click"), !1
					})
				}
			}
		...
		s.TEMPLATE = ['<a href="javascript:;" onclick="{onclick};"><img src="{src}" alt="{alt}" border="0"/></a>']
			.join(""), (s.getBtnHtml = function(t, e, n) {
				return arguments.callee.MODE[e] && arguments.callee.MODE[e](t, n)
			}).MODE = {
				standard: function(t) {
					var e = 1e4 + ~~C.get("__qc_wId");
					return y.format(s.TEMPLATE, {
						src: "https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/Connect_logo_" + t
							.size + ".png",
						onclick: t.fullWindow ? "return window.open('" + t.url + "', 'oauth2Login_" +
							e + "');" : "return window.open('" + t.url + "', 'oauth2Login_" + e +
				...
				showUserAfterLogin: function(t, e) {
					...
					return '<iframe frameBorder="0" scrolling="no" src="https://qzs.qq.com/qzone/openapi/frames/login_button.html#para=' +
						encodeURIComponent(n) + '" width="' + Math.max(200, e[0]) + '" height="' + e[1] +
				...
				return e && t.push("scope=" + e), n && (0 < n.indexOf("://") && (n = encodeURIComponent(n)), t.push(
						"redirect_uri=" + n)), "mobile" == o && t.push("display=" + o),
		...
		var c, o = function() {
				return p || function() {
					...
					if ((e = C.get("__qc__k")) && (t = e.split("="), e.length && 2 != t.length))
			...
			h = function() {
				...
				var a, s, e = function(t) {
						q.error(t + " : _getMeError"), window.callback({
							error_description: t
						})
					},
					c = function(t) {
						s = s || window.callback, t && c.cbPool.push(t), window.callback = function(t) {
							if (clearTimeout(i), t.openid) {
								var e, n = d = (u = t).openid,
									o = p;
								for (q.log(" getMe => openId & accessToken " + [n, o, a ? "通过me接口" :
										"通过本地"
									]); e = c.cbPool.shift();) e(n, p, t);
								a = null, window.callback = s
							}
						}, o() ? u ? window.callback(u) : a || ((a = document.createElement("script")).type =
							"text/javascript", a.src = "https://graph.qq.com/oauth2.0/me?access_token=" + p, a
							.onerror = function() {
								e("me接口返回格式错误")
							}, (t = document.getElementsByTagName("head")[0]) && t.appendChild(a), i =
							setTimeout(function() {
								e("me接口超时")
		...
		return w.extend(t, {
			...
			_onLoginBack: function(t, e, n) {
				t && e && (d = t, document.cookie = ["__qc__k=" + ["TC_MK", e].join("="), "path=/"]
					.join(";")), u = {
	...
	g.init = function(o) {
		...
		if (R = o.appId, O = o.redirectURI, t.openid) g.Login.getMe(function(t, e, n) {
			!~~n.error && (n.client_id <= 0 || n.client_id % 1e6 == o.appId % 1e6) ? (R = n.client_id = o
					.appId || o.clientId || o.app_id || o.client_id || -1, g.api._ready && g.api._ready()) :
	...
	A = t("appid"), z = t("redirecturi"), A && (g.Console.info("检测到自动初始化参数\nappId:" + A + "\nrUri:" + z), isNaN(A) ? g
		.Console.error("参数appid错误") : z && 0 != z.indexOf("http") ? g.Console.error("参数rediectURI错误") : g.Event
		.domReady(function() {
			g.init({
				appId: A,
				redirectURI: z
	...
	}), QC.pv("graph.qq.com", "/open/connect/channel/pv")) : (A && QC.Login.check() ? (QC.Event.domReady(
			function() {
				QC.Login.getMe(function(t, e) {
					QC.Login._onLoginBack(t, e, 1)
				})
			}), QC.pv("graph.qq.com", "/open/connect/logged_in/pv")) : QC.pv("graph.qq.com", "/open/connect/pv"), QC
		.reportBNL(11236, A))
